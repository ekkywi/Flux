...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'services.gitea.base_url' => 'string',
            'services.gitea.token' => 'string',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./app/public/storage','logging.default',
...
'services.gitea.base_url','services.gitea.token','session.driver','session.lifetime','session.expire_on_close',
...
'sanctum.csrf-cookie','login','register','logout','api.environments.logs','console.dashboard','console.projects.index',
'console.projects.create','console.projects.store','console.projects.show','console.projects.assign-server','console.projects.deploy',
'admin.approvals.index','admin.approvals.approve','admin.approvals.reject','admin.users.index','admin.users.store',
'admin.users.edit','admin.users.update','admin.users.destroy','admin.users.archived','admin.users.restore',
'admin.logs.index','admin.security.master-key.index','admin.security.master-key.rotate','admin.cold-storage.index','admin.cold-storage.download',
'admin.cold-storage.restore','admin.servers.index','admin.servers.store','admin.servers.archived','admin.servers.test-link',
'admin.servers.deploy-key','admin.servers.update','admin.servers.destroy','admin.servers.restore','storage.local',);
        registerArgumentsSet('views', 
'admin.approvals.index','admin.cold_storage.index','admin.logs.index','admin.servers.archived','admin.servers.index',
'admin.users.archived','admin.users.index','auth.login','auth.register','console.dashboard',
'console.projects.index','console.projects.show','layouts.app','layouts.guest','security.master-key.index',
...
'AWS_BUCKET','AWS_USE_PATH_STYLE_ENDPOINT','VITE_APP_NAME','OCTANE_SERVER','APP_TIMEZONE',
'XDG_CONFIG_HOME','GITEA_BASE_URL','GITEA_TOKEN','REVERB_APP_ID','REVERB_APP_KEY',
