...
'web','api',);
        registerArgumentsSet('routes', 'login','register',
'logout','console.dashboard','admin.approvals.index','admin.approvals.approve','admin.approvals.reject',
'admin.users.index','admin.users.store','admin.users.edit','admin.users.update','admin.users.destroy',
'admin.users.archived','admin.users.restore','admin.logs.index','admin.security.master-key.index','admin.security.master-key.rotate',
'admin.servers.index','admin.servers.store','admin.servers.test-link','storage.local',);
        registerArgumentsSet('views', 
'admin.approvals.index','admin.logs.index','admin.servers.index','admin.users.archived','admin.users.index',
'auth.login','auth.register','console.dashboard','layouts.app','layouts.guest',
'security.master-key.index','welcome','laravel-exceptions-renderer::components.badge','laravel-exceptions-renderer::components.empty-state','laravel-exceptions-renderer::components.file-with-line',
